function [XC,S,C,SSE,varexpl]=PCHA(X,noc,I,U,delta,varargin)
...
%         pause(0.000001);
%         varexpl=(SST-SSE)/SST;
%         fprintf('%12.0f | %12.4f | %12.4e | %12.4e | %12.4e | %12.4e | %12.4e | %12.4f \n',iter,full(varexpl),full(SSE),full(dSSE(1))/abs(full(SSE)),muC,mualpha,muS,t1-told);
%     end
end
...
% disp(dline);
% disp(dline);
% fprintf('%12.0f | %12.4f | %12.4e | %12.4e | %12.4e | %12.4e | %12.4e | %12.4f \n',iter,full(varexpl),full(SSE),full(dSSE)/abs(full(SSE)),muC,mualpha,muS,t1-told);
